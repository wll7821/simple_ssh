...
import com.wll7821.convertor.ConvertorUtils;
...
public class ActionFilter implements Filter{
	...
	public void init(FilterConfig config) throws ServletException {
		...
		try {
			Class.forName("com.wll7821.filter.ApplicationContext");
	...
	/**框架作者标识②*/
	public static void wll7821(){
		System.err.println("@DEVELOPED BY WLL7821@");
	}
